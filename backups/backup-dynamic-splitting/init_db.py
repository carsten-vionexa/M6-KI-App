...
# --------------------------------------------------------------------
# Spliiter Mode festlegen

SPLIT_MODE = "classic"   # 'classic', 'semantic', oder 'hybrid'

print("📁 Lade PDF-Dokumente ...")
docs = load_pdfs(str(PDF_PATH), split_mode=SPLIT_MODE)
print(f"✅ {len(docs)} Chunks im Modus '{SPLIT_MODE}' erstellt.")

# --------------------------------------------------------------------
# Embeddings erzeugen
print("🧠 Erstelle Embeddings mit Ollama ...")
embedder = get_embedder()  # nutzt mxbai-embed-large
